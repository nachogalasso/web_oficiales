...
urlpatterns = [
    ...
    path('officials/<str:id>', views.officialsPage, name='officials'),
    path('account/', views.accountSettings, name='acc_settings'),
    path('available/<str:id>', views.availabilityPage, name='available'),
    path('update_available/<str:id>', views.updateAvailability, name='update_available'),
    path('delete_available/<str:id>', views.deleteAvailability, name='delete_available'),
